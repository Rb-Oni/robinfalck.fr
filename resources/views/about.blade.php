...
<div class="container mx-auto mb-5 w-screen md:w-1/3">
    ...
    <div class="flex flex-col text-white font-semibold">
        <p class="mb-10 text-md lg:text-lg text-center">Robin, 24 ans, Développeur web junior. J'essaye de coder des sites web quand je code pas des sites web, en ce moment je travaille sur un projet Laravel.</p>
